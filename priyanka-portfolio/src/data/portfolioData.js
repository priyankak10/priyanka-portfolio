export const portfolioData = {
  ...
  summary:
    "Software Engineer with 9+ years of experience delivering enterprise engineering platforms across React frontend, Node.js microservices, and .NET systems. Led full ownership of CI Tool WebUI and PLCPortal, owned multiple CI backend APIs, and drove a full migration of WebUI deployments from Cloud Foundry to self-hosted Kubernetes.",
  skills: {
  ...
  experience: [
    {
      ...
      location: "Bengaluru, India",
      highlights: [
        "Contributed to CI Tool as a distributed platform with one frontend and multiple backend services; fully owned WebUI and owned api-prs, api-programs, api-builds, and api-queue services.",
        "Built CI Tool WebUI from scratch as a production-ready baseline for end-to-end CI reporting and operational tracking.",
        "Implemented backend APIs, filtering, validations, metrics, and event publication capabilities across PR, program, build, and queue workflows.",
        "Resolved production issues in reservation flows, path selection, form behavior, reset logic, and request-header validation to improve reliability.",
      ],
    },
  ],
  keyOwnership: [
